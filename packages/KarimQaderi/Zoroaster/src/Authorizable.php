<?php
    ...
    trait Authorizable
    {
         ...
         * @return bool
         */
        public function authorizedToView($model)
        {
            if(!self::authorizable()) return false;

            return  Gate::check('view' ,auth()->user(), $this->resource);
        }
         ...
         * @return bool
         */
        public function authorizedToAdd(ResourceRequest $request , $model)
        {
            if(!static::authorizable())
            {
                return true;
         ...
         * @return bool
         */
        public function authorizedToAttachAny(ResourceRequest $request , $model)
        {
            if(!static::authorizable())
            {
                return true;
         ...
         * @return bool
         */
        public function authorizedToAttach(ResourceRequest $request , $model)
        {
            if(!static::authorizable())
            {
                return true;
         ...
         * @return bool
         */
        public function authorizedToDetach(ResourceRequest $request , $model , $relationship)
        {
            if(!static::authorizable())
            {
                return true;
