<?php
    ...
    abstract class Trend extends RangedMetric
    {
         ...
         * @return \KarimQaderi\Zoroaster\Metrics\TrendResult
         */
         ...
         * @param  Carbon $endingDate
         * @param  string $unit
         * @param  mixed $timezone
         * @param  bool $twelveHourTime
         * @return array
         */
        protected function getAllPossibleDateResults(Carbon $startingDate , Carbon $endingDate ,
         ...
         * @return string
         */
        protected function formatPossibleAggregateResultDate(Carbon $date , $unit , $twelveHourTime)
        {
            switch($unit){
                case 'month':
                    return __($date->format('F')) . ' ' . $date->format('Y');
