...
@section('content')
    ...
    <h1 class="resourceName">ایکون ها</h1>
    ...
    <div class="card-w uk-padding-small">
        ...
        <h4 class="uk-heading-line uk-margin-top"><span>Devices</span></h4>
        ...
        <h4 class="uk-heading-line uk-margin-top"><span>Storage</span></h4>
        ...
        <h4 class="uk-heading-line uk-margin-top"><span>Direction</span></h4>
        ...
        <h4 class="uk-heading-line uk-margin-top"><span>Editor</span></h4>
        ...
        <h4 class="uk-heading-line uk-margin-top"><span>Brands</span></h4>
