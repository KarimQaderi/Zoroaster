...
return [
    ...
    */
    ...
    'notifications'=> 'لطفا :attribute خوده را تو پنل وارد کنید.',
    ...
    */
    ...
    'attributes' => [
        ...
        "second" => "ثانیه",
        "title" => "عنوان نوشته",
        "title_fa" => "عنوان نوشته فارسی",
        "title_en" => "عنوان نوشته انگلیسی",
        "text" => "متن",
        "content" => "محتوا",
        "description" => "توضیحات",
        "excerpt" => "گلچین کردن",
        ...
        "available" => "موجود",
        "size" => "اندازه",
        "slug" => "ادرس یکتا (  نامک در آدرس ) ",
        "mal_id" => "ایدی پست mal",
        "dic_title_fa"=>"نام انیمه فارسی",
        "dic_title_en"=>"نام انیمه انگلیسی",
        "mal_image_url"=>"ادرس عکس mal",
        "mal_link"=>"ادرس پست mal",
        "price"=>"قیمت",
